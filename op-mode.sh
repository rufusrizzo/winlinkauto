...
tmux send -t winlinkauto:3 "multitail -i /var/log/winlinkauto/ardop.log -i /var/log/winlinkauto/ardop/`ls -ltr /var/log/winlinkauto/ardop/ | tail -1 | awk '{print $9}'`" C-m

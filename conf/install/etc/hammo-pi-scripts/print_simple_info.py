...
f = open("/home/riley/bin/display-info.txt","r")
lines = f.readlines()
#print(lines)
TEMPHUM=lines[0]
GRIDSQ=lines[1]
...
# Draw the text
draw.text((0, 0), TEMPHUM, font=font, fill=255)
draw.text((0, 20), GRIDSQ, font=font, fill=255)
draw.text((0, 46), TIMESS, font=font, fill=255)

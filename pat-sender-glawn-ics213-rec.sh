...
<RMS_Express_Form>
  ...
  <variables>
    <message>KF4EMZ, Riley, Waynesboro, Augusta, VA, USA (HF)</message>
    ...
    <subjectline>GLAWN Check-in HF</subjectline>
    <msgp2p></msgp2p>
    ...
    <formtitle></formtitle>
    <msgbody>KF4EMZ, Riley, Waynesboro, Augusta, VA, USA.  I'm working on linux scripts to automate the connection to RMS gws, I want to get it usable for other people.  I'm also working on Some small APRS digipeters built on a Raspberry Pi 0.  I head the digital station for our clubs Field Day, I want to add a APRS display for people.  I also want to try a few new groups for Field Day outreach.</msgbody>
    ...
    <message2>KF4EMZ, Riley, Waynesboro, VA (HF)</message2>
...
4. Subject: GLAWN Check-in
5. Date: ${date}
6. Time: ${time}
7. Message: 

KF4EMZ, Riley, Waynesboro, Augusta, VA, USA HF
...
Senders Template Version: ICS 213  v.41.12" | pat compose --from KF4EMZ --subject "213-Winlink Wednesday-GLAWN Check-In - ${date} ${time}" --attachment "${ics_form}" KB8RCR, riley@netandnix.net
rm "${ics_form}"
